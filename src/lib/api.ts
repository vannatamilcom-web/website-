...
export const MOCK_NEWS = [
  {
    ...
    summaryEn: "Chief Minister M.K. Stalin unveiled Tamil Nadu's new industrial policy aimed at accelerating the state's economic growth.",
  ...
  },
  {
    ...
    summaryEn: "Chennai Super Kings defeated Mumbai Indians in a thrilling match to secure an impressive victory.",
  ...
  },
  {
    ...
    summaryEn: "Apple has introduced the new iPhone 16 series with several upgraded features and strong market expectations.",
  ...
  },
  {
    ...
    summaryEn: "A new film starring a popular actor and directed by a leading filmmaker has been officially announced.",
  ...
  },
  {
    ...
    summaryEn: "The World Bank expects India's economy to grow by 7.5% in the current financial year.",
