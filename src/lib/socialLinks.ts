...
export const FACEBOOK_URL = normalizeFacebookUrl(
  import.meta.env.VITE_FACEBOOK_URL || import.meta.env.VITE_FACEBOOK_PAGE_URL || ''
);

export const FACEBOOK_PAGE_URL = normalizeFacebookUrl(import.meta.env.VITE_FACEBOOK_PAGE_URL || '');
export const INSTAGRAM_URL = normalizeInstagramUrl(import.meta.env.VITE_INSTAGRAM_URL || '');
